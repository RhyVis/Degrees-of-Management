...
object FoundationRegistry : AbstractRegistry<Foundation>("foundation")

object GameRegistry : AbstractRegistry<GameInstance>("instance")

object LayerRegistry : AbstractRegistry<Layer>("layer")

object ModRegistry : AbstractRegistry<Mod>("mod")
